...
public class EmpCloud_RegisterOrganization_Post_Api_Test {
	
	@Test
	void PostEmpcloudRegisterOrganization() throws InterruptedException
	{
		...
		//Response object
		Response response =httprequest.request(Method.POST,"/v1/data/reg-org-s3");
