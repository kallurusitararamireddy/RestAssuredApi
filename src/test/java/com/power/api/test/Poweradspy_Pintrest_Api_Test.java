...
public class Poweradspy_Pintrest_Api_Test {
	
	@Test
	void getPintrestResponce() throws InterruptedException
	{
		...
		Reporter.log("<B><font color = 'orange'> Pintrest API Responce  -</font>is :"+ statusCode);
